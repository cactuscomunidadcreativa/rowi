...
async function main() {
  ...
  const achievementsData = [
    ...
    { slug: "avatar_baby", name: "Rowi Bebe", nameEN: "Baby Rowi", description: "Tu Rowi evoluciono a etapa Bebe", descriptionEN: "Your Rowi evolved to Baby stage", category: "GENERAL", requirement: "CUSTOM", threshold: 1, points: 75, rarity: "UNCOMMON", icon: "heart", color: "#fb923c" },
    { slug: "avatar_young", name: "Rowi Joven", nameEN: "Young Rowi", description: "Tu Rowi evoluciono a etapa Joven", descriptionEN: "Your Rowi evolved to Young stage", category: "GENERAL", requirement: "CUSTOM", threshold: 1, points: 100, rarity: "RARE", icon: "star", color: "#3b82f6" },
    { slug: "avatar_adult", name: "Rowi Adulto", nameEN: "Adult Rowi", description: "Tu Rowi evoluciono a etapa Adulto", descriptionEN: "Your Rowi evolved to Adult stage", category: "GENERAL", requirement: "CUSTOM", threshold: 1, points: 150, rarity: "EPIC", icon: "crown", color: "#8b5cf6" },
    { slug: "avatar_wise", name: "Rowi Sabio", nameEN: "Wise Rowi", description: "Tu Rowi alcanzo la maxima evolucion: Sabio", descriptionEN: "Your Rowi reached maximum evolution: Wise", category: "GENERAL", requirement: "CUSTOM", threshold: 1, points: 300, rarity: "LEGENDARY", icon: "award", color: "#10b981" },
