...
const KEYS: Record<string, Five> = {
  ...
  "scenarios.baseHint": {
    es: "Escribe en este idioma y traduce con IA.",
    en: "Write in this language and translate with AI.",
    pt: "Escreva neste idioma e traduza com IA.",
    it: "Scrivi in questa lingua e traduci con l'IA.",
    zh: "用此语言撰写，再用 AI 翻译。",
  },
  "scenarios.translate": {
    es: "Traducir con IA a los demás idiomas",
    en: "Translate to other languages with AI",
    pt: "Traduzir para outros idiomas com IA",
    it: "Traduci nelle altre lingue con l'IA",
    zh: "用 AI 翻译成其他语言",
  },
  "scenarios.error.base.required": {
    es: "Completa título y brief en el idioma base.",
    en: "Fill in title and brief in the base language.",
    pt: "Preencha título e brief no idioma base.",
    it: "Compila titolo e brief nella lingua base.",
    zh: "请用基础语言填写标题和脚本。",
  },
