...
const translations = {
  ...
  pt: {
    ...
    back: "Voltar ao tour",
    prev: "Anterior: ECO",
    suggestedTitle: "Tente perguntar...",
    inputPlaceholder: "Digite sua mensagem...",
    send: "Enviar",
    featuresTitle: "Capacidades do Coach",
    feature1: "Respostas personalizadas baseadas no seu perfil SEI",
    feature2: "Exercícios e técnicas de inteligência emocional",
    feature3: "Acompanhamento do seu progresso e evolução",
    feature4: "Disponível 24/7 sem limites de conversa",
  ...
  it: {
    ...
    back: "Torna al tour",
    prev: "Precedente: ECO",
    suggestedTitle: "Prova a chiedere...",
    inputPlaceholder: "Scrivi il tuo messaggio...",
    send: "Invia",
    featuresTitle: "Capacità del Coach",
    feature1: "Risposte personalizzate basate sul tuo profilo SEI",
    feature2: "Esercizi e tecniche di intelligenza emotiva",
    feature3: "Monitoraggio del tuo progresso ed evoluzione",
    feature4: "Disponibile 24/7 senza limiti di conversazione",
