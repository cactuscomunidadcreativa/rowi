...
const translations = {
  ...
  pt: {
    ...
    title: "Dashboard",
    subtitle: "Seu centro de controle emocional com todas as suas métricas SEI",
    back: "Voltar ao tour",
    next: "Próximo: Affinity",
    userGreeting: "Olá",
    userLevel: "Nível",
    eqScore: "Pontuação EQ Total",
    eqOf: "de",
    pursuitsTitle: "Os 3 Propósitos",
    pursuitsDesc: "O modelo SEI da Six Seconds organiza as 8 competências em 3 propósitos",
    competenciesTitle: "8 Competências SEI",
    competenciesDesc: "Cada competência mede um aspecto específico da sua inteligência emocional",
    outcomesTitle: "Resultados de Vida",
    outcomesDesc: "Como sua inteligência emocional impacta diferentes áreas da sua vida",
    tipTitle: "Isto é um demo",
    tipDesc: "Na sua conta real, estes dados virão da sua avaliação SEI da Six Seconds e serão atualizados com seu progresso.",
    createAccount: "Criar minha conta",
  },
  it: {
    badge: "Demo Interattivo",
    title: "Dashboard",
    subtitle: "Il tuo centro di controllo emotivo con tutte le tue metriche SEI",
    back: "Torna al tour",
    next: "Avanti: Affinity",
    userGreeting: "Ciao",
    userLevel: "Livello",
    eqScore: "Punteggio EQ Totale",
    eqOf: "di",
    pursuitsTitle: "I 3 Propositi",
    pursuitsDesc: "Il modello SEI di Six Seconds organizza le 8 competenze in 3 propositi",
    competenciesTitle: "8 Competenze SEI",
    competenciesDesc: "Ogni competenza misura un aspetto specifico della tua intelligenza emotiva",
    outcomesTitle: "Risultati di Vita",
    outcomesDesc: "Come la tua intelligenza emotiva impatta diverse aree della tua vita",
