...
const translations = {
  ...
  pt: {
    ...
    back: "Voltar ao tour",
    prev: "Anterior: Affinity",
    next: "Próximo: Rowi Coach",
    recipientTitle: "Destinatário",
    recipientDesc: "A mensagem se adapta ao estilo cerebral e preferências de comunicação",
    brainStyle: "Estilo Cerebral",
    channelTitle: "Canal de Comunicação",
    channelDesc: "Selecione o canal para ver como o Rowi adapta a mensagem",
    messageTitle: "Mensagem Otimizada",
    messageDesc: "Gerada por IA adaptada ao perfil emocional de Carlos",
    regenerate: "Regenerar",
    copy: "Copiar",
    copied: "Copiado",
    send: "Enviar",
  ...
  it: {
    ...
    back: "Torna al tour",
    prev: "Precedente: Affinity",
    next: "Avanti: Rowi Coach",
    recipientTitle: "Destinatario",
    recipientDesc: "Il messaggio si adatta allo stile cerebrale e alle preferenze di comunicazione",
    brainStyle: "Stile Cerebrale",
    channelTitle: "Canale di Comunicazione",
    channelDesc: "Seleziona il canale per vedere come Rowi adatta il messaggio",
    messageTitle: "Messaggio Ottimizzato",
    messageDesc: "Generato da IA adattato al profilo emotivo di Carlos",
    regenerate: "Rigenera",
    copy: "Copia",
    copied: "Copiato",
    send: "Invia",
