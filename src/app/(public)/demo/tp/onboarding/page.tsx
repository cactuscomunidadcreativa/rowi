...
const translations = {
  ...
  pt: {
    badge: "Onboarding TP",
    backToTP: "Voltar ao Benchmark TP",
    welcomeTitle: "Bem-vindo ao Rowi",
    welcomeSubtitle: "Sua plataforma de inteligência emocional na Teleperformance",
    welcomeDesc: "Nos próximos minutos, você descobrirá seu perfil de inteligência emocional e como pode crescer dentro da TP.",
    welcomeFeatures: [
      "Avaliação SEI personalizada",
      "Comparação com benchmarks da TP",
      "Matching de equipe",
      "Coach de IA disponível 24/7",
    ],
    startBtn: "Começar minha jornada",
    profileTitle: "Seu Perfil na TP",
    profileSubtitle: "Conte-nos sobre sua função para personalizar sua experiência",
    profileRegion: "Região",
    profileRole: "Função atual",
    profileDept: "Departamento",
    profileNewHire: "Você é novo contratado?",
    continueBtn: "Continuar",
    assessmentTitle: "Avaliação SEI",
    assessmentSubtitle: "Simulação da avaliação Six Seconds SEI",
    assessmentNote: "Em produção, aqui se integra o assessment real da Six Seconds. Para este demo, mostramos resultados simulados.",
    simulateBtn: "Simular avaliação completa",
    resultsTitle: "Seus Resultados SEI",
    resultsSubtitle: "Seu perfil de inteligência emocional",
    eqScore: "Pontuação EQ Total",
    yourScore: "Sua pontuação",
    tpAverage: "Média TP",
    roleAverage: "Média da sua função",
    topPerformer: "Top Performers",
    brainProfile: "Seu Perfil Cerebral",
    topTalents: "Seus Top Talentos",
    seeMatches: "Ver minha equipe",
    matchTitle: "Sua Equipe",
    matchSubtitle: "Pessoas com alta compatibilidade emocional na sua área",
    compatibility: "Compatibilidade",
    brainStyle: "Perfil Cerebral",
    finishBtn: "Completar onboarding",
    demoNote: "Este é um demo do fluxo de onboarding. Em produção, cada funcionário da TP completaria este processo com dados reais.",
  },
  it: {
    badge: "Onboarding TP",
    backToTP: "Torna al Benchmark TP",
    welcomeTitle: "Benvenuto su Rowi",
    welcomeSubtitle: "La tua piattaforma di intelligenza emotiva in Teleperformance",
    welcomeDesc: "Nei prossimi minuti, scoprirai il tuo profilo di intelligenza emotiva e come puoi crescere all'interno di TP.",
    welcomeFeatures: [
      "Valutazione SEI personalizzata",
      "Confronto con i benchmark TP",
      "Matching del team",
      "Coach IA disponibile 24/7",
    ],
    startBtn: "Inizia il mio viaggio",
    profileTitle: "Il tuo Profilo TP",
    profileSubtitle: "Raccontaci il tuo ruolo per personalizzare la tua esperienza",
    profileRegion: "Regione",
    profileRole: "Ruolo attuale",
    profileDept: "Dipartimento",
    profileNewHire: "Sei una nuova assunzione?",
    continueBtn: "Continua",
    assessmentTitle: "Valutazione SEI",
    assessmentSubtitle: "Simulazione della valutazione Six Seconds SEI",
    assessmentNote: "In produzione, qui si integra l'assessment reale di Six Seconds. Per questo demo, mostriamo risultati simulati.",
    simulateBtn: "Simula valutazione completata",
    resultsTitle: "I tuoi Risultati SEI",
    resultsSubtitle: "Il tuo profilo di intelligenza emotiva",
    eqScore: "Punteggio EQ Totale",
    yourScore: "Il tuo punteggio",
    tpAverage: "Media TP",
    roleAverage: "Media del tuo ruolo",
    topPerformer: "Top Performer",
    brainProfile: "Il tuo Profilo Cerebrale",
    topTalents: "I tuoi Top Talenti",
    seeMatches: "Vedi la mia squadra",
    matchTitle: "La tua Squadra",
    matchSubtitle: "Persone con alta compatibilità emotiva nella tua area",
    compatibility: "Compatibilità",
    brainStyle: "Profilo Cerebrale",
    finishBtn: "Completa onboarding",
    demoNote: "Questo è un demo del flusso di onboarding. In produzione, ogni dipendente TP completerebbe questo processo con dati reali.",
  },
};
