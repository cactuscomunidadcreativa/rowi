...
const translations = {
  ...
  pt: {
    ...
    title: "Benchmark EQ",
    titleHL: "Teleperformance",
    subtitle: "14.886 avaliações SEI analisadas. Descubra o perfil de inteligência emocional da sua organização global.",
    overview: "Visão Geral",
    competencies: "Competências SEI",
    outcomes: "Outcomes",
    brainProfiles: "Perfis Cerebrais",
    regions: "Distribuição Regional",
    byFunction: "Por Área Funcional",
    insights: "Insights Principais",
    avgEQ: "EQ Médio",
    assessments: "Avaliações",
    countries: "Países",
    topCompetency: "Competência Mais Forte",
    avg: "Média",
    topPerformer: "Top Performer",
    globalAvg: "Média Global TP",
    seiScale: "Escala SEI: 65-135",
    ctaTitle: "Quer ver isso com seus dados?",
    ctaSubtitle: "O Rowi analisa automaticamente suas avaliações SEI e gera insights acionáveis.",
    ctaButton: "Solicitar demo personalizada",
    tryOnboarding: "Testar onboarding TP",
    back: "Voltar ao demo",
    infoTip: "Estes dados são um demo baseado em avaliações SEI reais da Teleperformance. O Rowi pode processar qualquer dataset da Six Seconds.",
    poweredBy: "Powered by Rowi × Six Seconds",
  },
  it: {
    badge: "Demo Teleperformance",
    title: "Benchmark EQ",
    titleHL: "Teleperformance",
    subtitle: "14.886 valutazioni SEI analizzate. Scopri il profilo di intelligenza emotiva della tua organizzazione globale.",
    overview: "Panoramica",
    competencies: "Competenze SEI",
    outcomes: "Outcomes",
    brainProfiles: "Profili Cerebrali",
    regions: "Distribuzione Regionale",
    byFunction: "Per Area Funzionale",
    insights: "Insight Chiave",
    avgEQ: "EQ Medio",
    assessments: "Valutazioni",
    countries: "Paesi",
    topCompetency: "Competenza Più Forte",
    avg: "Media",
    topPerformer: "Top Performer",
    globalAvg: "Media Globale TP",
    seiScale: "Scala SEI: 65-135",
    ctaTitle: "Vuoi vederlo con i tuoi dati?",
    ctaSubtitle: "Rowi analizza automaticamente le tue valutazioni SEI e genera insight azionabili.",
    ctaButton: "Richiedi demo personalizzata",
    tryOnboarding: "Prova onboarding TP",
    back: "Torna al demo",
    infoTip: "Questi dati sono un demo basato su valutazioni SEI reali di Teleperformance. Rowi può processare qualsiasi dataset di Six Seconds.",
    poweredBy: "Powered by Rowi × Six Seconds",
  },
};
