...
function getDefaultPageContent(slug: string): any[] {
  const contents: Record<string, any[]> = {
    home: [
      { type: "HERO", order: 0, config: { pageSlug: "home", layout: "split", showBadge: true, showTrustBadges: true, gradient: true }, content: { es: { badge: "Inteligencia emocional con IA · respaldada por Six Seconds", title1: "Conócete mejor.", title2: "Conecta mejor.", subtitle: "Rowi es la IA que te ayuda a entender tus emociones, mejorar tus relaciones y liderar mejor — con la metodología líder en inteligencia emocional.", ctaPrimary: "Comenzar gratis", ctaSecondary: "Ver demo", image: "/rowivectors/Rowi-06.webp", trustBadges: [{ icon: "shield", text: "Datos privados y seguros" }, { icon: "globe", text: "Respaldado por Six Seconds" }, { icon: "star", text: "Presente en +200 países" }] }, en: { badge: "AI emotional intelligence · backed by Six Seconds", title1: "Know yourself better.", title2: "Connect better.", subtitle: "Rowi is the AI that helps you understand your emotions, improve your relationships, and lead better — with the leading methodology in emotional intelligence.", ctaPrimary: "Start free", ctaSecondary: "Watch demo", image: "/rowivectors/Rowi-06.webp", trustBadges: [{ icon: "shield", text: "Private and secure data" }, { icon: "globe", text: "Backed by Six Seconds" }, { icon: "star", text: "In 200+ countries" }] } } },
      { type: "STATS", order: 1, config: { pageSlug: "home", layout: "gradient", columns: 4 }, content: { es: { stats: [{ value: "200", prefix: "+", label: "Países y territorios" }, { value: "500,000", prefix: "+", label: "Evaluaciones realizadas" }, { value: "27", label: "Idiomas" }, { value: "1997", label: "Desde" }] }, en: { stats: [{ value: "200", prefix: "+", label: "Countries and territories" }, { value: "500,000", prefix: "+", label: "Assessments taken" }, { value: "27", label: "Languages" }, { value: "1997", label: "Since" }] } } },
      { type: "WORLD_MAP", order: 2, config: { pageSlug: "home" }, content: {} },
      { type: "EVOLUTION", order: 3, config: { pageSlug: "home" }, content: {} },
      { type: "FEATURES", order: 4, config: { pageSlug: "home", columns: 3, showIcons: true }, content: { es: { title1: "Todo lo que necesitas para", title2: "crecer emocionalmente", features: [{ icon: "sparkles", title: "Coach IA Personal", description: "Tu coach 24/7" }, { icon: "brain", title: "Evaluación SEI", description: "Evaluación científica" }, { icon: "heart", title: "Afinidad", description: "Conecta con personas afines" }] }, en: { title1: "Everything you need to", title2: "grow emotionally", features: [{ icon: "sparkles", title: "Personal AI Coach", description: "Your 24/7 coach" }, { icon: "brain", title: "SEI Assessment", description: "Scientific assessment" }, { icon: "heart", title: "Affinity", description: "Connect with like-minded people" }] } } },
      { type: "CTA", order: 5, config: { pageSlug: "home", gradient: true }, content: { es: { title: "¿Listo para conocer a tu Rowi?", subtitle: "Comienza gratis.", buttonText: "Comenzar ahora", buttonIcon: "heart" }, en: { title: "Ready to meet your Rowi?", subtitle: "Start free.", buttonText: "Get started now", buttonIcon: "heart" } } },
    ],
    "how-it-works": [
