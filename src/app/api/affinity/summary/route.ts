// src/app/api/affinity/summary/route.ts
...
export async function GET(req: NextRequest) {
  try {
    ...
    /* =========================================================
       ...
       ✅ CAMBIO: usamos startedAt en lugar de createdAt
    ========================================================== */
    const latestAffinity = await prisma.batch.findFirst({
      where: { ownerId: me.id, type: "affinity" },
      orderBy: { startedAt: "desc" }, // ✅ aquí el cambio
    });
    ...
    await prisma.batch.create({
      data: {
        ...
        count: heats.length,
        status: "completado",
        startedAt: new Date(), // ✅ campo real de tu modelo
      },
    });
