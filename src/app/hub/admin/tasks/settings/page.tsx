...
export default function TasksSettingsPage() {
  ...
  const txt = {
    title: lang !== "es" ? "Task Settings" : "Configuración de Tareas",
    description: lang !== "es" ? "Configure task behavior and notifications" : "Configura el comportamiento de tareas y notificaciones",
    notifications: lang !== "es" ? "Notifications" : "Notificaciones",
    enableNotifications: lang !== "es" ? "Enable task notifications" : "Habilitar notificaciones de tareas",
    overdueReminders: lang !== "es" ? "Send overdue reminders" : "Enviar recordatorios de tareas vencidas",
    dailyDigest: lang !== "es" ? "Daily task digest" : "Resumen diario de tareas",
    weeklyReport: lang !== "es" ? "Weekly progress report" : "Reporte semanal de progreso",
    taskBehavior: lang !== "es" ? "Task Behavior" : "Comportamiento de Tareas",
    autoArchive: lang !== "es" ? "Auto-archive after (days)" : "Archivar automáticamente después de (días)",
    defaultPriority: lang !== "es" ? "Default priority" : "Prioridad por defecto",
    allowSubtasks: lang !== "es" ? "Allow subtasks" : "Permitir subtareas",
    requireDueDate: lang !== "es" ? "Require due date" : "Requerir fecha de vencimiento",
    features: lang !== "es" ? "Features" : "Características",
    emotionalTracking: lang !== "es" ? "Emotional tracking on tasks" : "Seguimiento emocional en tareas",
    gamification: lang !== "es" ? "Gamification & achievements" : "Gamificación y logros",
    save: lang !== "es" ? "Save Settings" : "Guardar Configuración",
    saved: lang !== "es" ? "Settings saved" : "Configuración guardada",
    high: lang !== "es" ? "High" : "Alta",
    medium: lang !== "es" ? "Medium" : "Media",
    low: lang !== "es" ? "Low" : "Baja",
  };
