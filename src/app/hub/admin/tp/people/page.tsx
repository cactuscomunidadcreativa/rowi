...
/* =========================================================
   Translations — central t() via buildT()
   Builds a flat Record<string, string> so child components keep
   their `t: Record<string, string>` contract and dynamic lookups
   (t[COMP_TKEYS[key]], t[outcomeKey]) keep working.
========================================================= */
type Copy = Record<string, string>;

function buildT(t: (key: string, fallback?: string) => string): Copy {
  return {
    backToHub: t("tpPeople.backToHub", "TP Hub"),
    badge: t("tpPeople.badge", "Comparador de Personas"),
    pageTitle: t("tpPeople.pageTitle", "Comparador Persona vs Persona"),
    pageSubtitle: t(
      "tpPeople.pageSubtitle",
    ...
    selectPersonA: t("tpPeople.selectPersonA", "Seleccionar Persona A"),
    selectPersonB: t("tpPeople.selectPersonB", "Seleccionar Persona B"),
    searchPlaceholder: t("tpPeople.searchPlaceholder", "Buscar por ID, pais, rol..."),
    selectPrompt: t("tpPeople.selectPrompt", "Selecciona dos personas para iniciar la comparacion"),
    eqTotal: t("tpPeople.eqTotal", "EQ Total"),
    brainStyle: t("tpPeople.brainStyle", "Estilo Cerebral"),
    role: t("tpPeople.role", "Rol"),
    region: t("tpPeople.region", "Region"),
    country: t("tpPeople.country", "Pais"),
    competencyRadar: t("tpPeople.competencyRadar", "Radar de Competencias"),
    competencyRadarDesc: t(
      "tpPeople.competencyRadarDesc",
      "Superposicion de las 8 competencias SEI de ambas personas"
    ),
    competencyTable: t("tpPeople.competencyTable", "Comparacion por Competencia"),
    competencyTableDesc: t(
      "tpPeople.competencyTableDesc",
      "Puntaje, delta y quien lidera en cada competencia"
    ),
    outcomesComparison: t("tpPeople.outcomesComparison", "Resultados de Vida"),
    outcomesDesc: t("tpPeople.outcomesDesc", "Comparacion de outcomes entre ambas personas"),
    complementaryAnalysis: t("tpPeople.complementaryAnalysis", "Analisis Complementario"),
    complementaryDesc: t(
      "tpPeople.complementaryDesc",
      "Fortalezas y debilidades complementarias entre las dos personas seleccionadas"
    ),
    strongerIn: t("tpPeople.strongerIn", "Mas fuerte en"),
    sharedStrengths: t("tpPeople.sharedStrengths", "Fortalezas Compartidas"),
    sharedGaps: t("tpPeople.sharedGaps", "Brechas Compartidas"),
    noSharedStrengths: t("tpPeople.noSharedStrengths", "No hay fortalezas compartidas (>105)"),
    noSharedGaps: t("tpPeople.noSharedGaps", "No hay brechas compartidas (<95)"),
    competency: t("tpPeople.competency", "Competencia"),
    personAScore: t("tpPeople.personAScore", "Persona A"),
    personBScore: t("tpPeople.personBScore", "Persona B"),
    delta: t("tpPeople.delta", "Delta"),
    leads: t("tpPeople.leads", "Lidera"),
    tie: t("tpPeople.tie", "Empate"),
    effectiveness: t("tpPeople.effectiveness", "Efectividad"),
    relationships: t("tpPeople.relationships", "Relaciones"),
    wellbeing: t("tpPeople.wellbeing", "Bienestar"),
    qualityOfLife: t("tpPeople.qualityOfLife", "Calidad de Vida"),
    compEL: t("tpPeople.compEL", "Alfabetizacion Emocional"),
    compRP: t("tpPeople.compRP", "Reconocer Patrones"),
    compACT: t("tpPeople.compACT", "Pensamiento Consecuente"),
    compNE: t("tpPeople.compNE", "Navegar Emociones"),
    compIM: t("tpPeople.compIM", "Motivacion Intrinseca"),
    compOP: t("tpPeople.compOP", "Ejercer Optimismo"),
    compEMP: t("tpPeople.compEMP", "Aumentar Empatia"),
    compNG: t("tpPeople.compNG", "Metas Nobles"),
    infoTitle: t("tpPeople.infoTitle", "Datos de Comparacion TP"),
    infoDesc: t(
      "tpPeople.infoDesc",
    ...
    navTeams: t("tpPeople.navTeams", "Teams"),
    navSelection: t("tpPeople.navSelection", "Selection"),
    vsLabel: t("tpPeople.vsLabel", "VS"),
    eqComparison: t("tpPeople.eqComparison", "Comparacion EQ Total"),
    loading: t("tpPeople.loading", "Cargando datos..."),
    loadingError: t("tpPeople.loadingError", "Error al cargar datos. Intenta de nuevo."),
    retry: t("tpPeople.retry", "Reintentar"),
    filters: t("tpPeople.filters", "Filtros"),
    clearFilters: t("tpPeople.clearFilters", "Limpiar filtros"),
    allRegions: t("tpPeople.allRegions", "Todas las regiones"),
    allCountries: t("tpPeople.allCountries", "Todos los paises"),
    allRoles: t("tpPeople.allRoles", "Todos los roles"),
    allBrainStyles: t("tpPeople.allBrainStyles", "Todos los estilos"),
    totalResults: t("tpPeople.totalResults", "resultados"),
    noResults: t("tpPeople.noResults", "No se encontraron datos con los filtros seleccionados"),
    reliability: t("tpPeople.reliability", "Confiabilidad"),
  };
}
