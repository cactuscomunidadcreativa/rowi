...
/* =========================================================
   Translations — central t() under the "tpWorld.*" namespace.
   buildCopy() resolves every key once per render so the existing
   `copy.x` and `copy[dynamicKey]` lookups keep working unchanged.
========================================================= */
type TFn = (key: string, fallback?: string) => string;

function buildCopy(t: TFn) {
  return {
    backToHub: t("tpWorld.backToHub", "TP Hub"),
    badgeLabel: t("tpWorld.badgeLabel", "Benchmark Global"),
    pageTitle: t("tpWorld.pageTitle", "Benchmark Global — Teleperformance"),
    pageSubtitle: t(
      "tpWorld.pageSubtitle",
      "TP vs. el benchmark global Rowiverse. Comparaciones con datos reales de la comunidad global y el top 10%.",
    ),
    selectorTitle: t("tpWorld.selectorTitle", "Seleccionar Comparación"),
    benchmarkTPvsGlobal: t("tpWorld.benchmarkTPvsGlobal", "TP vs Rowiverse Global"),
    benchmarkTPvsBPO: t("tpWorld.benchmarkTPvsBPO", "TP vs Percentil 25"),
    benchmarkTPvsTop10: t("tpWorld.benchmarkTPvsTop10", "TP vs Top 10%"),
    headToHeadTitle: t("tpWorld.headToHeadTitle", "Comparación Directa"),
    sampleSize: t("tpWorld.sampleSize", "Muestra"),
    avgEQ: t("tpWorld.avgEQ", "EQ Promedio"),
    compChartTitle: t("tpWorld.compChartTitle", "Comparación de Competencias"),
    compChartDesc: t("tpWorld.compChartDesc", "8 competencias SEI: TP vs benchmark seleccionado (datos reales Rowiverse)"),
    delta: t("tpWorld.delta", "Delta"),
    compEL: t("tpWorld.compEL", "Alfabetización Emocional"),
    compRP: t("tpWorld.compRP", "Reconocer Patrones"),
    compACT: t("tpWorld.compACT", "Pensamiento Consecuente"),
    compNE: t("tpWorld.compNE", "Navegar Emociones"),
    compIM: t("tpWorld.compIM", "Motivación Intrínseca"),
    compOP: t("tpWorld.compOP", "Ejercer Optimismo"),
    compEMP: t("tpWorld.compEMP", "Aumentar Empatía"),
    compNG: t("tpWorld.compNG", "Metas Nobles"),
    outcomesTitle: t("tpWorld.outcomesTitle", "Comparación de Resultados"),
    outcomesDesc: t("tpWorld.outcomesDesc", "Resultados de vida: TP vs benchmark seleccionado"),
    outcomeEffectiveness: t("tpWorld.outcomeEffectiveness", "Efectividad"),
    outcomeRelationships: t("tpWorld.outcomeRelationships", "Relaciones"),
    outcomeWellbeing: t("tpWorld.outcomeWellbeing", "Bienestar"),
    outcomeQuality: t("tpWorld.outcomeQuality", "Calidad de Vida"),
    regionalTitle: t("tpWorld.regionalTitle", "Posicionamiento Regional TP"),
    regionalDesc: t("tpWorld.regionalDesc", "Cada región TP comparada con el promedio global y la industria BPO"),
    region: t("tpWorld.region", "Región"),
    regionAvgEQ: t("tpWorld.regionAvgEQ", "EQ Prom"),
    regionN: t("tpWorld.regionN", "N"),
    vsGlobal: t("tpWorld.vsGlobal", "vs Global"),
    vsBPO: t("tpWorld.vsBPO", "vs BPO"),
    rank: t("tpWorld.rank", "Posición"),
    differentiatorTitle: t("tpWorld.differentiatorTitle", "Diferenciadores de Top Performers"),
    differentiatorDesc: t("tpWorld.differentiatorDesc", "Qué distingue a los top performers de TP vs el promedio general"),
    competency: t("tpWorld.competency", "Competencia"),
    tpTopAvg: t("tpWorld.tpTopAvg", "TP Top Prom"),
    tpAllAvg: t("tpWorld.tpAllAvg", "TP Prom General"),
    globalTopAvg: t("tpWorld.globalTopAvg", "Global Top Prom"),
    gap: t("tpWorld.gap", "Brecha"),
    impact: t("tpWorld.impact", "Impacto"),
    impactHigh: t("tpWorld.impactHigh", "Alto"),
    impactMedium: t("tpWorld.impactMedium", "Medio"),
    impactLow: t("tpWorld.impactLow", "Bajo"),
    exceedsGlobal: t("tpWorld.exceedsGlobal", "Supera al promedio"),
    successTitle: t("tpWorld.successTitle", "Patrones de Éxito por Rol"),
    successDesc: t("tpWorld.successDesc", "Las fórmulas de competencias que definen a los top performers en cada función"),
    successFormula: t("tpWorld.successFormula", "Fórmula de Éxito"),
    topPerformerMatch: t("tpWorld.topPerformerMatch", "de top performers con este patrón"),
    keyInsight: t("tpWorld.keyInsight", "Hallazgo clave"),
    gapTitle: t("tpWorld.gapTitle", "Brecha hacia Clase Mundial"),
    gapDesc: t("tpWorld.gapDesc", "Cuánto necesita mejorar TP para alcanzar el top 10% global"),
    current: t("tpWorld.current", "Actual TP"),
    target: t("tpWorld.target", "Objetivo (Top 10%)"),
    gapPoints: t("tpWorld.gapPoints", "Brecha"),
    gapSummary: t("tpWorld.gapSummary", "TP necesita +{points} puntos promedio para alcanzar el top 10% mundial"),
    infoTitle: t("tpWorld.infoTitle", "Datos de Benchmarking"),
    infoDesc: t("tpWorld.infoDesc", "Todas las comparaciones utilizan datos 100% reales del benchmark Rowiverse (300,000+ evaluaciones globales) y datos reales de TP. Los percentiles se calculan directamente de la base de datos."),
    referenceData: t("tpWorld.referenceData", "Benchmark Rowiverse (datos reales)"),
    liveData: t("tpWorld.liveData", "Datos en vivo TP (API)"),
    navROI: t("tpWorld.navROI", "ROI"),
    navAlerts: t("tpWorld.navAlerts", "Alertas"),
    loading: t("tpWorld.loading", "Cargando datos del benchmark..."),
    errorTitle: t("tpWorld.errorTitle", "Error al cargar datos"),
    errorDesc: t("tpWorld.errorDesc", "No se pudieron cargar los datos del benchmark. Intenta de nuevo más tarde."),
    retry: t("tpWorld.retry", "Reintentar"),
    noData: t("tpWorld.noData", "Sin datos disponibles"),
    outcomeLabel: t("tpWorld.outcomeLabel", "Outcome"),
    topPerformersCount: t("tpWorld.topPerformersCount", "Top Performers"),
    effectSize: t("tpWorld.effectSize", "Effect Size"),
  };
}
    ...
    <div className="space-y-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-gray-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-6 mb-4 text-xs">
          <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full" style={{ backgroundColor: "#7B2D8E" }} /><span>{tFn("tpWorld.teleperformance", "Teleperformance")}</span></div>
