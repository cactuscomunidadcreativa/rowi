...
export default function WeekFlowSettingsPage() {
  ...
  const txt = {
    title: lang !== "es" ? "WeekFlow Settings" : "Configuración de WeekFlow",
    description: lang !== "es" ? "Configure weekly sessions and notifications" : "Configura las sesiones semanales y notificaciones",
    notifications: lang !== "es" ? "Notifications" : "Notificaciones",
    enableNotifications: lang !== "es" ? "Enable WeekFlow notifications" : "Habilitar notificaciones de WeekFlow",
    weeklyReminder: lang !== "es" ? "Send weekly session reminder" : "Enviar recordatorio semanal",
    reminderDay: lang !== "es" ? "Reminder day" : "Día del recordatorio",
    reminderTime: lang !== "es" ? "Reminder time" : "Hora del recordatorio",
    sessionConfig: lang !== "es" ? "Session Configuration" : "Configuración de Sesión",
    sessionDuration: lang !== "es" ? "Session duration (minutes)" : "Duración de sesión (minutos)",
    maxContributions: lang !== "es" ? "Max contributions per user" : "Máx. contribuciones por usuario",
    contributions: lang !== "es" ? "Contribution Types" : "Tipos de Contribución",
    enableShowAndTell: lang !== "es" ? "Enable Show & Tell section" : "Habilitar sección Show & Tell",
    enableToDiscuss: lang !== "es" ? "Enable To Discuss section" : "Habilitar sección A Discutir",
    enableFocus: lang !== "es" ? "Enable Focus section" : "Habilitar sección Focus",
    enableTasks: lang !== "es" ? "Enable Tasks section" : "Habilitar sección Tareas",
    moodConfig: lang !== "es" ? "Mood Check-in" : "Check-in de Ánimo",
    enableMoodCheckin: lang !== "es" ? "Enable mood check-in" : "Habilitar check-in de ánimo",
    requireMoodCheckin: lang !== "es" ? "Require mood before contributing" : "Requerir ánimo antes de contribuir",
    gamification: lang !== "es" ? "Gamification" : "Gamificación",
    enableGamification: lang !== "es" ? "Enable gamification & points" : "Habilitar gamificación y puntos",
    showLeaderboard: lang !== "es" ? "Show leaderboard" : "Mostrar tabla de posiciones",
    enableStreaks: lang !== "es" ? "Enable participation streaks" : "Habilitar rachas de participación",
    save: lang !== "es" ? "Save Settings" : "Guardar Configuración",
    saved: lang !== "es" ? "Settings saved successfully" : "Configuración guardada correctamente",
    saveError: lang !== "es" ? "Error saving settings" : "Error al guardar la configuración",
    loadError: lang !== "es" ? "Error loading settings" : "Error al cargar la configuración",
    selectHub: lang !== "es" ? "Select a hub" : "Selecciona un hub",
    hub: lang !== "es" ? "Hub / Community" : "Hub / Comunidad",
    monday: lang !== "es" ? "Monday" : "Lunes",
    tuesday: lang !== "es" ? "Tuesday" : "Martes",
    wednesday: lang !== "es" ? "Wednesday" : "Miércoles",
    thursday: lang !== "es" ? "Thursday" : "Jueves",
    friday: lang !== "es" ? "Friday" : "Viernes",
  };
